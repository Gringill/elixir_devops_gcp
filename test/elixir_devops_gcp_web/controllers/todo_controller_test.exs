defmodule ElixirDevopsGcpWeb.TodoControllerTest do
  use ElixirDevopsGcpWeb.ConnCase

  alias ElixirDevopsGcp.Data

  @create_attrs %{comp: true, desc: "some desc", name: "some name"}
  @update_attrs %{comp: false, desc: "some updated desc", name: "some updated name"}
  @invalid_attrs %{comp: nil, desc: nil, name: nil}

  def fixture(:todo) do
    {:ok, todo} = Data.create_todo(@create_attrs)
    todo
  end
